class Mode{
    constructor(elementsColor, elementsColorTint, backgroundColor, textColor, inputColor, nightIconFAStyleClass){
        this.cssVars = {}
...
const lightMode = new Mode('hsl(0, 0%, 100%)', 'hsl(0, 0%, 96%)', 'hsl(0, 0%, 98%)', 'hsl(200, 15%, 8%)', 'hsl(0, 0%, 52%)', 'fa-regular')
const darkMode = new Mode('hsl(209, 23%, 22%)', 'hsl(209, 23%, 28%)', 'hsl(207, 26%, 17%)', 'hsl(0, 0%, 100%)', 'hsl(0, 0%, 52%)', 'fa-solid')
